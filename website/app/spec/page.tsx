...
export default function SpecPage() {
  return (
    <div>
      {/* Dark hero */}
      <section className="relative border-b border-surface-800 bg-surface-900 py-20 lg:py-24">
        <div className="absolute inset-0 grid-pattern opacity-50" />
        <div className="relative mx-auto max-w-4xl px-6">
          <p className="font-sans text-xs font-semibold uppercase tracking-widest text-accent-400">
            Specification
          </p>
          <h1 className="mt-4 font-sans text-4xl font-bold tracking-tight text-surface-100 lg:text-5xl">
            OSP v1.0
          </h1>
      ...
      <section className="bg-white py-20 lg:py-24">
        <div className="mx-auto max-w-4xl px-6">
          {/* Table of contents */}
          <nav className="mb-16 rounded-lg border border-gray-200 bg-gray-50 p-6">
            <h2 className="font-sans text-xs font-semibold uppercase tracking-widest text-gray-400">
              Contents
            </h2>
            <ul className="mt-4 columns-2 gap-8 space-y-2">
              ...
              <li>
                <a
                  ...
                  className="text-sm text-gray-600 transition-colors duration-150 hover:text-gray-900"
                >
                  <span className="font-mono text-gray-400 mr-2">&mdash;</span>
                  Endpoint Reference
                </a>
              </li>
            </ul>
          ...
          <div className="space-y-16">
            {sections.map((section) => (
              <article key={section.id} id={section.id} className="scroll-mt-24">
                ...
                <p className="mt-4 text-gray-600 leading-7 max-w-prose">
                  {section.content}
                </p>
              </article>
            ))}
          ...
          {/* Endpoint reference */}
          <div id="endpoints" className="mt-20 scroll-mt-24">
            <h2 className="font-sans text-2xl font-bold text-gray-900">
              Endpoint Reference
            </h2>
            <div className="mt-8 overflow-hidden rounded-lg border border-gray-200">
              <table className="w-full text-left text-sm">
                <thead className="bg-gray-50 border-b border-gray-200">
                  <tr>
                    <th className="px-5 py-3 font-sans text-xs font-semibold uppercase tracking-widest text-gray-400">
                      Method
                    </th>
                    <th className="px-5 py-3 font-sans text-xs font-semibold uppercase tracking-widest text-gray-400">
                      Path
                ...
                <tbody className="divide-y divide-gray-100">
                  {endpoints.map((ep) => (
                    ...
                    >
                      ...
                      <td className="px-5 py-3.5 text-gray-600">{ep.desc}</td>
                    </tr>
                  ))}
                </tbody>
              </table>
          ...
          {/* Bottom CTA */}
          <div className="mt-20 rounded-lg border border-blue-200 bg-blue-50 p-8 text-center">
